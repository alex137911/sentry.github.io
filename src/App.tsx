...
const slides = [
  {
    ...
    img: "public/slide-img/consultation.png",
    imageWidth: 343,
    imageHeight: 375,
  },
  {
    title: "Recording",
    img: "public/slide-img/spatial-audio.jpeg",
    imageWidth: 211,
    imageHeight: 375,
  },
  {
    title: "Data Report",
    img: "public/slide-img/audio-sharing.jpeg",
    imageWidth: 265,
    imageHeight: 352,
    centered: true,
  },
  {
    title: "Placeholder 1",
    img: "public/slide-img/automatic-switching.jpeg",
    imageWidth: 336,
    imageHeight: 100,
    centered: true,
  },
  {
    title: "Placeholder 2",
    img: "public/slide-img/siri.jpeg",
    imageWidth: 168,
    imageHeight: 168,
    centered: true,
  },
  {
    title: "Accessibility",
    img: "public/slide-img/a11y.jpeg",
    imageWidth: 135,
    imageHeight: 135,
    centered: true,
  },
  ...
  return (
    <div className="bg-gray-200 min-h-screen font-sans py-16">
      <h2 className="font-semibold text-6xl text-center max-w-[800px] mx-auto mb-20">
        Sleep Sentry: Overnight Sleep Recording
      </h2>
